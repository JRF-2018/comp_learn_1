#!/usr/bin/python3
# -*- coding: utf-8 -*-
__version__ = '0.0.4' # Time-stamp: <2019-05-15T20:17:01Z>
...
pnd = neg_coeff * (outputs1 - outputs2) * tf.exp(- tf.reduce_sum(tf.square(outputs1 - outputs2), axis=1, keepdims=True) / (2 * neg_sigma **2))
pn1 = pnd + outputs2
pn2 = - pnd + outputs1
